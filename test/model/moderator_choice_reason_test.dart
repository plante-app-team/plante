...
void main() {
  ...
  test('persistent ID have not changed', () {
    final idsMap = {
      ...
      ModeratorChoiceReason
          .AMBIGUOUS_INGREDIENTS_ARE_ALMOST_ALWAYS_VEGETARIAN_IN_MODERN_FOOD_INDUSTRY: 5,
      ModeratorChoiceReason
          .MANUFACTURER_CONFIRMED_NON_VEGETARIAN_INGREDIENTS_ABSENCE: 6,
      ModeratorChoiceReason
      ...
      ModeratorChoiceReason
          .MANUFACTURER_CONFIRMED_NON_VEGETARIAN_INGREDIENTS_PRESENCE: 11,
      ModeratorChoiceReason
      ...
      ModeratorChoiceReason
          .SOME_OF_PRODUCT_SERIES_HAVE_NON_VEGETARIAN_INGREDIENTS: 16,
  ...
  test('all reasons are either vegan or vegetarian', () {
    final veganAndVegetarianStatuses =
        (veganModeratorChoiceReasons() + vegetarianModeratorChoiceReasons())
            .toSet();
