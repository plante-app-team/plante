...
import 'map_page_mode_default_test.mocks.dart';

@GenerateMocks([PermissionsManager, ShopsManager, LocationController, GoogleMapController])
void main() {
  ...
  final shopsMap = { for (final shop in shops) shop.osmId: shop };
  ...
  setUp(() async {
    ...
    when(shopsManager.fetchShops(any, any)).thenAnswer((_) async => Ok(shopsMap));
