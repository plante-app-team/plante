...
class _$OsmAddress extends OsmAddress {
  ...
  factory _$OsmAddress([void Function(OsmAddressBuilder)? updates]) =>
      (new OsmAddressBuilder()..update(updates))._build();
  ...
  int get hashCode {
    ...
    _$hash = $jc(_$hash, cityDistrict.hashCode);
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'OsmAddress')
